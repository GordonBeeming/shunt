...
// macOS volumes are case-insensitive by default, so a cwd basename or arg like
// "myApp" must still resolve the registered "MyApp". Returns the canonical
// registered name, its config dir, and whether it was found.
